...
<div data-barba="container" class="about" data-barba-namespace="about" data-header-color="dark">
    ...
    <div class="relative container my-14">
        <h2 class="gradient-text text-7xl w-3/4 font-normal">Our platform is designed to elevate sales performance and inspire team motivation.</h2>
        ...
        <div class="flex flex-col relative">
            <h2 class="text-6xl text-gray-800 mb-5 w-3/4">Adapting and evolving with clients</h2>
             ...
             <div class="w-full flex jic">
                ...
                <div class="sm:w-3/4 w-full ml-auto mr-0 mt-10 ">
                        <p class="sm:w-3/4 w-full mr-0 ml-auto leading-normal text-2xl text-[var(--mainColor)] indent-8"><b>Since 1985</b> we have been digging deep to understand our customers’ needs and we get it done for them.<br><br>
    ...
    <div class="container my-20 about-us-aob">
        <div class="flex items-stretch gap-3 column-mobile">
            <h2 class="bg-gray-200 hover:bg-[var(--secondaryColor)] hover:shadow-md smooth-t text-gray-800 py-10 text-5xl w-[70%] rounded-lg text-center">Committed for the long term.</h2>
    ...
    <div class="container my-52">
        <div class="flex flex-col relative">
            <h2 class="text-4xl text-center text-gray-800 mb-5">Our company in numbers</h2>
             <?php get_template_part('template-parts/about-numbers'); ?>   
        </div>
    </div>
