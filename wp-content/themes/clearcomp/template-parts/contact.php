<div class="fixed top-0 left-0 w-full min-h-100 flex contact-form-container opacity-0  pointer-events-none fw3 z-[999]">
  <div class="contact-bg min-h-100 w-[40%] desktop"></div>
  <div class="w-[60%] bg-[var(--mainColorLight)] contact-content container p-20 flex relative">
