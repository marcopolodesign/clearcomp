<div class="container rounded-xl bg-gray-100 flex p-10 my-<?php the_sub_field('margin');?> relative overflow-hidden">
    <div class="py-20 flex flex-col jic m-auto">
        <h3 class="text-6xl gradient-text font-normal text-center px-20"><?php the_sub_field('title');?></h3>
        <?php 
        ...
        <div class="absolute left-0 top-0 w-[25%]">
            <?php get_template_part('template-parts/assets/line-left'); ?>
        </div>

        <div class="absolute right-0 bottom-0 w-[25%]">
