<?php
if( have_rows('reusable', 6) ):
    while( have_rows('reusable', 6) ): the_row();

        if( have_rows('solutions_grid_content', 6) ):
            while( have_rows('solutions_grid_content', 6) ): the_row(); ?>
